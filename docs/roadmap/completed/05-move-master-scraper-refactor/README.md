...
flowchart TD
    ...
    P4 --> P06[次計画群 XX-ma-full-data（全種族投入）]
```
...
> を完了 → 本計画群（05）→ [XX-ma-full-data](../../XX-ma-full-data/README.md)（全種族投入）。04 / 06 へ戻る依存は無い。
...
- **着手前提**: 先行する [04-generated-layout-redesign](../04-generated-layout-redesign/README.md) を Phase 1-3
  ...
  Champions 準拠で揃い整理済みパイプラインができた状態で [XX-ma-full-data](../../XX-ma-full-data/README.md) の全種族投入へ繋ぐ。
