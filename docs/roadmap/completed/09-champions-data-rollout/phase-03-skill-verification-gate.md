...
- [ ] **判定を記録する**:
  - **健全（OK）**: 全量本投入（[11-static-restore-hardening Phase 3](../../11-static-restore-hardening/phase-03-full-rollout.md) へ cross-plan move 済み）へ進む。判定根拠を本 phase doc / PR コメント等に残す。
