...
- 名前辞書 from-scratch 復元堅牢化 + 非 third-party PR 作成 + distinct-forms 名対応 + M-A・M-B 全件本投入 計画 → [`11-static-restore-hardening/README.md`](./11-static-restore-hardening/)
...
| [completed/10-showdown-first-data](./completed/10-showdown-first-data/README.md) | ✅ 完了 |
| [11-static-restore-hardening](./11-static-restore-hardening/README.md) | 🚧 進行中 |
