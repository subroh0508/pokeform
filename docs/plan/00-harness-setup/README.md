...
- [ ] [Phase 2 — レトロスペクティブ & ハーネス改良ループ](./phase-2-retrospective-loop.md) ← PR ごと KPT レトロ→ハーネス書き戻し（merge **後**）
- [ ] [Phase 3 — コードレビュー Skill](./phase-3-code-review.md) ← PR merge **前**の意味的レビュー＋auto-merge。Phase 2 と対の品質ループ
- [ ] [Phase 4 — ADR の仕組み](./phase-4-adr.md) ← 早期に確立し、以降の決定をその場で記録
- [ ] [Phase 5 — ツールチェーンとバージョン固定](./phase-5-toolchain-and-versions.md)
- [ ] [Phase 6 — Docker 化](./phase-6-dockerize.md)
- [ ] [Phase 7 — rules と CLAUDE.md](./phase-7-rules-and-claude-md.md)
- [ ] [Phase 8 — 中核 Skills](./phase-8-core-skills.md)
- [ ] [Phase 9 — 検証ゲート（Git hooks + Claude 補助 hooks）](./phase-9-verification-gates.md)
