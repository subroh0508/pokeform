...
flowchart TD
    ...
    P12 --> P13[phase-13 — data/ ディレクトリ説明 README]
    P13 --> P14[phase-14 — M-A 全データ投入]
```
...
- [ ] [Phase 13 — data/ ディレクトリ説明 README（ポインタ式・何を表す / 情報源 / 取得・更新 skill を索引化）](./phase-13-data-directory-readme.md)
- [ ] [Phase 14 — M-A 全データ投入（全186種 + 全 movepool）](./phase-14-ma-full-data.md)
