...
> 最終 phase（[phase-13](../03-survey-regulation-rework/phase-13-ma-full-data.md)）へ移動した。
...
> **旧 Phase 20（M-A 全データ投入）は [`03-survey-regulation-rework`](../03-survey-regulation-rework/README.md) の
> 最終 phase（[phase-13](../03-survey-regulation-rework/phase-13-ma-full-data.md)）へ移動**した。新パイプライン
