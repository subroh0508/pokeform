...
flowchart TD
    ...
    P4 --> P06[次計画群 09-ma-full-data（全種族投入）]
```
...
- [x] [Phase 4 — survey-regulation オーケストレーター化（roster / species-moves / move-master / items のサブスキル / Workflow 分割 + SKILL.md 縮減 + cross-agent パリティ）](./phase-04-skill-orchestration.md)
...
> を完了 → 本計画群（05）→ [09-ma-full-data](../09-ma-full-data/README.md)（全種族投入）。04 / 06 へ戻る依存は無い。
...
- **着手前提**: 先行する [04-generated-layout-redesign](../04-generated-layout-redesign/README.md) を Phase 1-3
  ...
  Champions 準拠で揃い整理済みパイプラインができた状態で [09-ma-full-data](../09-ma-full-data/README.md) の全種族投入へ繋ぐ。
