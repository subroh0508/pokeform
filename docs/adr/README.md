...
| [0011](./0011-implementation-workflow-orchestrator.md) | 実装は原則 `implementation-workflow` skill 経由で駆動する（多段フェーズで統合） | Accepted |
| [0012](./0012-typescript-language.md) | プログラミング言語に TypeScript を採用する | Accepted |
| [0013](./0013-nodejs-runtime.md) | ランタイムに Node.js を採用する | Accepted |
| [0014](./0014-pnpm-package-manager.md) | パッケージ管理に pnpm を採用する（corepack に依存しない） | Accepted |
| [0015](./0015-vitest-test-runner.md) | テストランナーに Vitest を採用する | Accepted |
| [0016](./0016-biome-linter.md) | Linter / Formatter に Biome を採用する | Accepted |
| [0017](./0017-toolchain-version-source-of-truth.md) | ツールチェーンのバージョンは package.json / lockfile / .node-version を唯一の情報源とし、メジャー含め最新追従する | Accepted |
| [0018](./0018-dockerize-dev-ci.md) | dev / CI 用に Docker 化する | Accepted |
...
| # | タイトル | Status |
|---|---|---|
| [0006](./archive/0006-pin-toolchain-and-dockerize.md) | ツールチェーンのバージョンをピン留めし、dev/CI 用に Docker 化する | Superseded by ADR-0012〜0018 |
