...
| [0034](./0034-move-meta-per-game-sot.md) | 技メタの SoT を per-game regulations/champions/moves.yaml にする（名前は catalog 維持・Champions 固有値・ADR 0026 改訂 supersede） | Accepted |
