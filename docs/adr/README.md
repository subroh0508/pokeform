...
| [0037](./0037-serebii-move-master-dedicated-path.md) | 技マスターを Serebii 技専用ページ（attackdex-champions）から専用取得する経路を追加する（取得方式を副産物抽出 → 専用取得へ・SoT / 出自は ADR 0035 のまま不変・補完） | Accepted |
