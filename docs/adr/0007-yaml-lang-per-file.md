...
個体 YAML・パーティ Markdown は、種族名・技・特性・持ち物・性格・能力名を**日本語名でも英名でも**書きたい（[ADR 0003](./0003-species-dex-pattern.md) で日英双方向マップを持つ）。しかし 1 ファイル内で日本語と英名が混在すると、曖昧さが生じ、エージェントにとって予測しにくく、誤記の検出も甘くなる。
