...
- **複数 phase**: `docs/plan/NN-{slug}/` に `OVERVIEW.md` / `README.md`（進捗チェックリスト + Mermaid 依存
  グラフ + phase 一覧）/ `phase-NN-<slug>.md`×N を作る。テンプレは
  [plan-templates.md](../skills/plans-new/references/plan-templates.md)、Phase doc 見出しの正本は
  [`docs/plan/README.md`](../../docs/plan/README.md)。`docs/plan/README.md` の採番一覧・全体進捗にも追記する。
...
- **既存 `00` / `01` の遡及改修はしない**（OVERVIEW の後付け等はスコープ外）。
...
- 計画インデックス・Phase doc 共通テンプレート: [`docs/plan/README.md`](../../docs/plan/README.md)。
