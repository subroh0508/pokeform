...
| **使用できる技（learnset legality）** | **PokeAPI に無し（Champions 非対応・ADR 0026）** | `regulations/<game>/<reg>.yaml` の per-species `moves`（Serebii 第一優先） | skill-authored |
