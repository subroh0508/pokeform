...
export const speciesNames = {
  ...
  "dudunsparce-two": {
    id: "dudunsparce-two",
    name: {
      en: "Dudunsparce (Two-Segment Form)",
      ja: "ノココッチ（ふたふしフォルム）",
    },
  },
  dugtrio: {
  ...
  "urshifu-single": {
    id: "urshifu-single",
    name: {
      en: "Urshifu (Single Strike Style)",
      ja: "ウーラオス（いちげきのかた）",
    },
  },
  uxie: {
