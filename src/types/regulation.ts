...
} from "../../data/generated/champions/index.ts";
 ...
 * （`data/generated/champions/<reg>/index.ts`）、`champions/index.ts`（集約）が `regulationDex` に集約して
...
export type { RegulationDex, RegulationId } from "../../data/generated/champions/index.ts";
/** 生成済みの regulationDex（値）/ RegulationDex（型）/ RegulationId を re-export する。 */
export { regulationDex } from "../../data/generated/champions/index.ts";
