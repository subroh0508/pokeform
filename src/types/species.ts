import type { AbilityId } from "../../data/generated/champions/ability-specs.ts";
import type { ItemId } from "../../data/generated/champions/item-specs.ts";
import { megaSpecsDex } from "../../data/generated/champions/mega-specs.ts";
import type { MoveId } from "../../data/generated/champions/move-specs.ts";
import { speciesSpecsDex } from "../../data/generated/champions/species-specs.ts";
 ...
 * `data/languages/species.yaml`・ADR 0035）。`data/generated/champions/species-specs.ts`（`speciesSpecsDex`）が
 ...
 * `data/generated/champions/mega-specs.ts`（`megaSpecsDex`）が派生する。
 */
 ...
 * 生成物は `data/generated/champions/<reg>/index.ts`（`speciesDex` を base/mega specs + species-moves +
...
export type { MegaSpecId, MegaSpecsDex } from "../../data/generated/champions/mega-specs.ts";
export type {
  SpeciesSpecId,
  SpeciesSpecsDex,
} from "../../data/generated/champions/species-specs.ts";
